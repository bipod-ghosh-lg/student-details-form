...
const Login = () => {
  ...
  return (
    <div className="h-full bg-gray-100 min-h-screen w-screen px-5 md:px-12 xl:px-32 2xl:px-40 py-4 md:py-12 2xl:py-10 gap-10 md:gap-0 flex flex-col-reverse md:flex-row justify-between overflow-hidden">
      <div className="absolute top-0 right-0 h-20 w-32 md:w-72 rounded-bl-lg bg-[#00BDD6]" />
      ...
      <div className="h-auto w-full flex flex-col justify-center items-start gap-4  ">
        <div className=" h-full bg-white max-h-[70%] w-full  z-20 md:w-[70%] xl:w-[60%] 2xl:w-[50%] relative  flex flex-col justify-center items-center rounded-lg shadow-lg  gap-4 xl:gap-5  px-4 py-5 xl:py-5 ">
      ...
      <div className="h-full w-full md:w-[50%] flex flex-col gap-5 justify-center items-end mt-12 md:mt-0  z-10   ">
        <div className=" w-[100%] flex justify-center">
          <img src={loginHeroImg} alt="" className=" object-contain h-[70%] md:h-full w-[70%] md:w-full"  />
        </div>
